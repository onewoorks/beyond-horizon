<template>
  <div class="centered-container">
    <md-content class="md-elevation-3">
      ...
      <div class="title">
        <img src="http://byondhorizon.com/images/BYONDHORIZONJan15.jpg">
        
        <div class="md-body-1">Integrated Inspection Reporting Portal</div>
      </div>
      ...
      <div class="actions md-layout md-alignment-center-space-between">
        ...
        <a href="/dashboard"><md-button class="md-raised md-primary" @click="auth">Log in</md-button></a>
      </div>
